...
import { ERC6551RegistryABI, ERC6551RegistryAddress } from '../config'
...
async function main () {
  ...
  const erc6551registryContract = new ethers.Contract(ERC6551RegistryAddress.main, ERC6551RegistryABI.abi, wallet)
  const implementation = ERC6551RegistryAddress.main // SimpleERC6551Account.sol address
